...
export default function SignIn({ onNavigate, onSignIn, onGoogleSignIn }: SignInProps) {
    ...
    <div className="min-h-screen bg-[#0F1116] text-white flex items-center justify-center">
      <div className="max-w-md w-full mx-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in to your account to continue creating</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-sm text-[#27AE60] hover:text-[#229954] transition-colors"
              >
                Forgot password?
              </button>
            </div>
